namespace LimbooCards.UnitTests.Domain
{
    public class PinEvaluatorServiceTests
    {
        ...
        {
            var planner = new Planner(Guid.NewGuid(), "Planner 1", new List<PlannerBucket> { new PlannerBucket(Guid.NewGuid(), "Default", true) }, null);
            ...
            var result = PinEvaluatorService.EvaluateCardPins(subject, planner, Guid.NewGuid());
        ...
        public void EvaluateCardPins_ShouldApplyPin_WhenRuleMatchesContentName()
        {
            ...
            var planner = new Planner(Guid.NewGuid(), "Planner 1", new List<PlannerBucket> { new PlannerBucket(Guid.NewGuid(), "Default", true) }, new List<PinRule> { rule });
        ...
        public void EvaluateCardPins_ShouldApplyMultiplePins_WhenMultipleRulesMatch()
        {
            ...
            var planner = new Planner(Guid.NewGuid(), "Planner 1", new List<PlannerBucket> { new PlannerBucket(Guid.NewGuid(), "Default", true) }, rules);
        ...
        public void EvaluateCardPins_ShouldApplyPin_WhenRuleWithAndMatches()
        {
            ...
            var planner = new Planner(
                Guid.NewGuid(), "Planner 1",
                new List<PlannerBucket> { new(Guid.NewGuid(), "Default", true) },
        ...
        public void EvaluateCardPins_ShouldReturnNull_WhenRuleWithAndDoesNotMatch()
        {
            ...
            var planner = new Planner(
                Guid.NewGuid(), "Planner 1",
                new List<PlannerBucket> { new PlannerBucket(Guid.NewGuid(), "Default", true) },
                new List<PinRule> { rule }
            );
